...
No se utilizo IA para realizacion de esta practica mas que para la configuracion del Makefile. La mayoria de su
contenido fue reutilizado de lo visto en clase de laboratorio con el ayudante, ademas de algunos ajustes por
nuestra parte. En el archivo se indica exactamente donde fue llevado a cabo su utilizacion.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
